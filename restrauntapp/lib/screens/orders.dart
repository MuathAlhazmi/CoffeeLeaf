                      ...
                      if (!snapshot.data!.docs.isEmpty) {
                        return ListView(
                            children: getExpenseItems(snapshot, context,
                                hasauth, _localAuthentication, authenticated));
                      } else {
                        return Center(
                          child: Text(
                            'لا يوجد أي  طلبات',
...
getExpenseItems(AsyncSnapshot<QuerySnapshot> snapshot, context, hasauth,
    _localAuthentication, authenticated) {
                                                            ...
                                                            children: [
                                                              Column(
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    'هل تريد حذف من الغاء هذا الطلب؟',
                                                                    style:
                                                                        TextStyle(
                                                                      color:
                                                                          mainColor,
